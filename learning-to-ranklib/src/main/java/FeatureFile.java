...
public class FeatureFile {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("/home/coreir/learning2rank/output.csv"))) {
            try (PrintWriter w = new PrintWriter("/home/coreir/learning2rank/features.txt")) {
                String line;
