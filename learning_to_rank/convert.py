...
convert("../features.txt", "files.train","files.train.query","files.train.group")
convert("../test/features.txt","files.test","files.test.query","files.test.group")
convert("../validate/features.txt","files.val","files.val.query","files.val.group")
